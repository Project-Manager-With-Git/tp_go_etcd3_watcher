...
func (proxy *ProducerProxy) InitFromOptions(options *clientv3.Config) error {
...
func (proxy *ProducerProxy) InitFromOptionsParallelCallback(options *clientv3.Config) error {
	cli, err := kafka.NewProducer(options)
	if err != nil {
		return err
	}
